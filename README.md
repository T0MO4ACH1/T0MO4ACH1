...
<h1 style="margin: 40px 0 20px 0; 
  ...
  <p style="color: Red;"><strong>Unfortunately, due to some restraints, this project is on hiatus for now, there is a much better version of it, but it is offline.</strong></p>
