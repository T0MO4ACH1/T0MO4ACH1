...
<h1 style="margin: 40px 0 20px 0; 
  ...
  <h3 style="color: #FF0000;">Unfortunately, due to some restraints, this project is on hiatus for now, there is a much better version of it, but it is offline.</h3>
